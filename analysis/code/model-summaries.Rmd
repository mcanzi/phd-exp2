...
emmeans(model.75.125, pairwise ~ condition | region * side)
summary(model.75.125)
```

## LMEM: 150-200 ms

```{r, message = F}
model.150.200.2 <- summarised.data(150, 200) %>% 
  lmer(formula = amplitude ~ condition * region * side + (1 | subject))
