...
```{r, warnings = FALSE}
ERP <- rbind(read.csv("EXP2.csv"), read.csv("EXP1_pt1.csv"), read.csv("EXP1_pt2.csv")) %>% 
            filter_if(~is.numeric(.), all_vars(!is.infinite(.)))

ERP <- ERP[(ERP$time >= -100) & (ERP$time <= 700),]
...
gavglme <- function(TP1, TP2, where) {
  ...
  lme_data <- filter(lme_data, region == where) # remove this line and change model to avg.mean ~ condition * region for full region / condition interactions. 
...
ggsave("./pictures/P3_Exp2.png", anterior_frontal, width = 11, height = 9, dpi = "print")
...
ggsave("./pictures/P4_Exp2.png", fronto_central, width = 11, height = 9, dpi = "print")
```
...
ggsave("./pictures/P7_Exp2.png", noafa123_af, width = 11, height = 9, dpi = "print")
...
ggsave("./pictures/P8_Exp2.png", noafa123_fc, width = 11, height = 9, dpi = "print")
...
ggsave("./pictures/P9_Exp2.png", anterior_frontal123, width = 11, height = 9, dpi = "print")
...
ggsave("./pictures/P10_Exp2.png", fronto_central123, width = 11, height = 9, dpi = "print")
```
...
ggsave("./pictures/P11_Exp2.png", noafa1CT_af, width = 11, height = 8, dpi = "print")
...
ggsave("./pictures/P12_Exp2.png", noafa1CT_fc, width = 11, height = 8, dpi = "print")
```
...
ggsave("./pictures/P13_Exp2.png", exp12anterior_frontal, width = 11, height = 9, dpi = "print")
...
ggsave("./pictures/P14_Exp2.png", exp12fronto_central, width = 11, height = 9, dpi = "print")
```
...
# some of these pictures will look different than on the thesis. This is because I manually changed scales for some of these pictures before printing them (e.g. one picture might have a -5 to 5 mV scale.. another might have a -2 to +2 mV). I tried to automate it in the function but results were mixed so I ended up changing those values with trial and error. 
